...
function buildWeeklyPlaceholderSchedule(startISO, endISO, dow, time, skipISO, label) {
  ...
  while (d <= end) {
    ...
    if (!skipISO.includes(iso)) out.push({ date: iso, time, type: 'aula', title: label });
...
// ────────────────────────────────────────────────────────
{
  ...
  schedule: [
    {date:'2026-08-12', time:'13:00', type:'aula', title:'Apresentação e divisão dos grupos; Rede de Urgência/Emergência; Acolhimento e Classificação de Risco'},
    {date:'2026-08-19', time:'13:00', type:'aula', title:'Queimadura, choque, anafilaxia; HAS e DM descompensados'},
    {date:'2026-08-26', time:'13:00', type:'seminario', title:'Simulação Grupo A (animais peçonhentos); Dor abdominal'},
    {date:'2026-09-02', time:'13:00', type:'prova', title:'Teste de Progresso ABEM'},
    {date:'2026-09-09', time:'13:00', type:'prova', title:'Avaliação Teórica 1 + OSCE 1 (A,B) / Prática em serviços (C,D,E,F)', assessmentId:'av1'},
    {date:'2026-09-16', time:'13:00', type:'evento', title:'Semana Integradora'},
    {date:'2026-09-23', time:'13:00', type:'evento', title:'SEMUNI'},
    {date:'2026-09-30', time:'13:00', type:'seminario', title:'Simulação Grupo D (tontura); Grupo E (dor lombar)'},
    {date:'2026-10-07', time:'13:00', type:'evento', title:'Julgamento Simulado CRM-DF'},
    {date:'2026-10-14', time:'13:00', type:'seminario', title:'Simulação Grupo F (tosse); Grupo G (dispneia)'},
    {date:'2026-10-21', time:'13:00', type:'aula', title:'Mordeduras: profilaxia raiva/tétano; Violência na APS'},
    {date:'2026-10-28', type:'evento', title:'Recesso do Dia do Servidor Público'},
    {date:'2026-11-04', time:'13:00', type:'seminario', title:'Simulação Grupo B (cefaleia); Grupo C (disúria)'},
    {date:'2026-11-11', time:'13:00', type:'aula', title:'Ansiedade e Reforma Psiquiátrica; Filme "Si può fare"'},
    {date:'2026-11-18', time:'13:00', type:'seminario', title:'Simulação Grupo H (depressão/ideação suicida); Grupo I (diarreia)'},
    {date:'2026-11-25', time:'13:00', type:'prova', title:'Avaliação Teórica 2 + OSCE 2', assessmentId:'av2'},
    {date:'2026-12-02', time:'13:00', type:'seminario', title:'Simulação Grupo J (álcool/dependência); Dor torácica'},
    {date:'2026-12-09', time:'13:00', type:'prova', title:'Avaliação Teórica 3 + OSCE 3', assessmentId:'av3'}
  ]
},
...
// ────────────────────────────────────────────────────────
{
  ...
  schedule: [
    {date:'2026-08-11', time:'08:00', type:'aula', title:'Apresentação / divisão dos grupos / motivações para ser médico'},
    {date:'2026-08-18', time:'08:00', type:'aula', title:'Motivações para escolha da especialidade (discussão de artigos)'},
    {date:'2026-08-25', time:'08:00', type:'seminario', title:'Atuação do Médico — Clínica médica'},
    {date:'2026-09-01', time:'08:00', type:'seminario', title:'Atuação do Médico — Cirurgia geral'},
    {date:'2026-09-08', time:'08:00', type:'seminario', title:'Atuação do Médico — Medicina da família e comunidade'},
    {date:'2026-09-15', time:'08:00', type:'evento', title:'Semana da Atividade Integradora (vale 1,5 pts)'},
    {date:'2026-09-22', type:'evento', title:'Semana Universitária — sem aula'},
    {date:'2026-09-29', time:'08:00', type:'seminario', title:'Atuação do Médico — Ginecologia-obstetrícia'},
    {date:'2026-10-06', time:'08:00', type:'seminario', title:'Atuação do Médico — Psiquiatria'},
    {date:'2026-10-13', time:'08:00', type:'seminario', title:'Atuação do Médico — Especialidades clínico-cirúrgicas'},
    {date:'2026-10-20', time:'08:00', type:'seminario', title:'Atuação do Médico — Pediatria'},
    {date:'2026-10-27', time:'08:00', type:'seminario', title:'Atuação do Médico — Especialidades exclusivamente clínicas'},
    {date:'2026-11-03', time:'08:00', type:'seminario', title:'Atuação do Médico — Especialidades exclusivamente cirúrgicas'},
    {date:'2026-11-10', time:'08:00', type:'seminario', title:'Atuação do Médico — Medicina de imagem e nuclear'},
    {date:'2026-11-17', time:'08:00', type:'seminario', title:'Atuação do Médico — Medicina legal e do trabalho'},
    {date:'2026-11-24', time:'08:00', type:'seminario', title:'Atuação do Médico — Medicina preventiva e saúde coletiva'},
    {date:'2026-12-07', time:'08:00', type:'evento', title:'Encerramento / Auto-avaliação'}
  ]
},
...
// ────────────────────────────────────────────────────────
{
  ...
  schedule: [
    ...
    {date:'2026-08-13', time:'08:00', type:'aula', title:'Apresentação da disciplina / Doença celíaca'},
    {date:'2026-08-13', time:'11:00', type:'aula', title:'Puericultura do adolescente e principais problemas'},
    {date:'2026-08-14', time:'08:00', type:'aula', title:'Médicos Saudáveis, Pacientes Saudáveis (online)'},
    {date:'2026-08-18', time:'11:00', type:'aula', title:'Como conduzir a criança com sopro'},
    {date:'2026-08-20', time:'08:00', type:'aula', title:'Radiologia na Pediatria'},
    {date:'2026-08-20', time:'11:00', type:'aula', title:'Sexualidade na adolescência'},
    {date:'2026-08-21', time:'08:00', type:'aula', title:'Erro Médico'},
    {date:'2026-08-25', time:'11:00', type:'aula', title:'Pneumonia'},
    {date:'2026-08-27', time:'08:00', type:'aula', title:'Adolescente — "Passando a bola"'},
    {date:'2026-08-27', time:'11:00', type:'aula', title:'Exame neurológico do lactente e criança maior'},
    {date:'2026-08-28', time:'08:00', type:'aula', title:'Anestesiologia em Pediatria'},
    {date:'2026-09-01', time:'11:00', type:'aula', title:'Crescimento: pré-escolar ao pré-adolescente'},
    {date:'2026-09-03', time:'08:00', type:'aula', title:'Discussão de casos — crescimento e puberdade'},
    {date:'2026-09-03', time:'11:00', type:'aula', title:'Discussão de casos — crescimento e puberdade'},
    {date:'2026-09-04', time:'08:00', type:'aula', title:'Incongruência de gênero'},
    {date:'2026-09-08', time:'11:00', type:'aula', title:'Cuidados paliativos'},
    {date:'2026-09-10', time:'08:00', type:'aula', title:'Infecção do trato urinário'},
    {date:'2026-09-10', time:'11:00', type:'aula', title:'Sistema locomotor e diagnóstico diferencial de artralgia'},
    {date:'2026-09-11', time:'08:00', type:'aula', title:'Urologia Pediátrica cirúrgica'},
    {date:'2026-09-15', time:'11:00', type:'seminario', title:'Atividade Integradora do Semestre (14 a 17/09)'},
    {date:'2026-09-17', time:'08:00', type:'seminario', title:'Atividade Integradora do Semestre (14 a 17/09)'},
    {date:'2026-09-17', time:'11:00', type:'seminario', title:'Atividade Integradora do Semestre (14 a 17/09)'},
    {date:'2026-09-18', time:'08:00', type:'aula', title:'Cirurgias otorrinolaringológicas na pediatria'},
    ...
    {date:'2026-10-01', time:'08:00', type:'aula', title:'Diagnóstico clínico/laboratorial de doenças genéticas'},
    {date:'2026-10-01', time:'11:00', type:'aula', title:'Diagnóstico clínico/laboratorial de doenças genéticas'},
    {date:'2026-10-02', time:'08:00', type:'aula', title:'Controle clínico no pós-operatório'},
    {date:'2026-10-06', time:'11:00', type:'aula', title:'Obesidade sindrômica/monogênica'},
    {date:'2026-10-08', time:'08:00', type:'prova', title:'PROVA PARCIAL — Módulo Adolescente', assessmentId:'prsa1'},
    {date:'2026-10-08', time:'11:00', type:'aula', title:'Infecção de vias aéreas superiores'},
    {date:'2026-10-09', time:'08:00', type:'aula', title:'Deformidade da coluna/quadril da criança'},
    {date:'2026-10-13', time:'11:00', type:'prova', title:'PROVA PARCIAL — Módulo Criança', assessmentId:'prsc1'},
    {date:'2026-10-15', time:'08:00', type:'aula', title:'Atividade física para crianças e adolescentes'},
    {date:'2026-10-15', time:'11:00', type:'aula', title:'Sepse'},
    {date:'2026-10-16', time:'08:00', type:'aula', title:'TCE e hemorragia subaracnoidea'},
    {date:'2026-10-20', time:'11:00', type:'aula', title:'Calendário vacinal'},
    {date:'2026-10-22', time:'08:00', type:'seminario', title:'Seminário da disciplina'},
    {date:'2026-10-22', time:'11:00', type:'seminario', title:'Seminário da disciplina'},
    {date:'2026-10-23', time:'08:00', type:'aula', title:'Oncologia Pediátrica'},
    {date:'2026-10-27', time:'11:00', type:'aula', title:'Dermatite atópica'},
    {date:'2026-10-29', time:'08:00', type:'aula', title:'Asma'},
    {date:'2026-10-29', time:'11:00', type:'aula', title:'Asma'},
    {date:'2026-10-30', time:'08:00', type:'aula', title:'Gestação na adolescência'},
    {date:'2026-11-03', time:'11:00', type:'aula', title:'Transtorno do espectro autista'},
    {date:'2026-11-05', time:'08:00', type:'aula', title:'Condições neurológicas crônicas'},
    {date:'2026-11-05', time:'11:00', type:'aula', title:'Depressão na Adolescência'},
    {date:'2026-11-06', time:'08:00', type:'aula', title:'Desvio/dismetrias dos MMII; pé da criança e adolescente'},
    {date:'2026-11-10', time:'11:00', type:'aula', title:'Homeopatia'},
    {date:'2026-11-12', time:'08:00', type:'aula', title:'Atividade de Extensão'},
    {date:'2026-11-12', time:'11:00', type:'aula', title:'Violência contra criança e adolescente'},
    {date:'2026-11-13', time:'08:00', type:'aula', title:'Apendicite em pacientes pediátricos'},
    {date:'2026-11-17', time:'11:00', type:'aula', title:'Desidratação'},
    {date:'2026-11-19', time:'08:00', type:'prova', title:'PROVA FINAL — Módulo Adolescente (8h-12h)', assessmentId:'prsa2'},
    ...
    {date:'2026-11-26', time:'08:00', type:'reposicao', title:'Reposição (com justificativa, 8h-12h)'},
    {date:'2026-11-27', time:'08:00', type:'prova', title:'PROVA — Módulo Cirurgia Pediátrica', assessmentId:'cirurgia'},

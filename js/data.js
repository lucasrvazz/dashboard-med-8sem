...
// ────────────────────────────────────────────────────────
{
  ...
  schedule: [
    {date:'2026-08-11', type:'aula', title:'Introdução à disciplina'},
    {date:'2026-08-12', type:'aula', title:'MINI PALS'},
    {date:'2026-08-18', type:'aula', title:'Bronquiolite viral aguda'},
    {date:'2026-08-19', type:'aula', title:'Distúrbios Respiratórios (Laringite/Crise; OVACE)'},
    {date:'2026-08-25', type:'aula', title:'Asma — Crise'},
    {date:'2026-08-26', type:'aula', title:'Convulsões em PS PED'},
    {date:'2026-09-01', type:'aula', title:'PCR'},
    {date:'2026-09-02', type:'aula', title:'Oxigenoterapia'},
    {date:'2026-09-08', type:'estagio', title:'Lab. Simulação — Ventilação'},
    {date:'2026-09-09', type:'aula', title:'PCR'},
    {date:'2026-09-15', type:'seminario', title:'Seminário Integrador (14 a 17/09)'},
    {date:'2026-09-16', type:'seminario', title:'Seminário Integrador (14 a 17/09)'},
    {date:'2026-09-22', type:'aula', title:'Febre sem sinais localizatórios'},
    {date:'2026-09-23', type:'aula', title:'Criança Gravemente Enferma'},
    {date:'2026-09-29', type:'estagio', title:'Lab. Simulação — Ventilação'},
    {date:'2026-09-30', type:'estagio', title:'Lab. Simulação — Ventilação/PCR'},
    {date:'2026-10-06', type:'estagio', title:'Lab. Simulação — PCR'},
    {date:'2026-10-07', type:'estagio', title:'Lab. Simulação — PCR'},
    {date:'2026-10-13', type:'aula', title:'Choque séptico'},
    {date:'2026-10-14', type:'aula', title:'Cetoacidose diabética'},
    {date:'2026-10-20', type:'prova', title:'PROVA PARCIAL', assessmentId:'av1'},
    {date:'2026-10-21', type:'aula', title:'Meningite e Encefalite'},
    {date:'2026-10-27', type:'aula', title:'Hidratação em Emergência Pediátrica (prática)'},
    {date:'2026-10-28', type:'evento', title:'Ponto facultativo — sem aula'},
    {date:'2026-11-03', type:'aula', title:'ITU em Emergência'},
    {date:'2026-11-04', type:'aula', title:'Intoxicações'},
    {date:'2026-11-10', type:'aula', title:'Distúrbio Ácido-Básico'},
    {date:'2026-11-11', type:'aula', title:'TCE'},
    {date:'2026-11-17', type:'aula', title:'Urgências Dermatológicas'},
    {date:'2026-11-18', type:'aula', title:'Queimados'},
    {date:'2026-11-24', type:'entrega', title:'Prazo final — vídeos atividade de extensão'},
    {date:'2026-11-24', type:'aula', title:'Cefaleia'},
    {date:'2026-11-25', type:'aula', title:'Emergências Hematológicas'},
    {date:'2026-12-01', type:'prova', title:'PROVA FINAL', assessmentId:'av2'},
    {date:'2026-12-02', type:'aula', title:'Apresentação dos vídeos — atividade de extensão'},
    {date:'2026-12-08', type:'aula', title:'Feedback / Encerramento'}
  ]
},
...
// ────────────────────────────────────────────────────────
{
  ...
  schedule: [
    {date:'2026-08-12', type:'aula', title:'Apresentação e divisão dos grupos; Rede de Urgência/Emergência; Acolhimento e Classificação de Risco'},
    {date:'2026-08-19', type:'aula', title:'Queimadura, choque, anafilaxia; HAS e DM descompensados'},
    {date:'2026-08-26', type:'seminario', title:'Simulação Grupo A (animais peçonhentos); Dor abdominal'},
    {date:'2026-09-02', type:'prova', title:'Teste de Progresso ABEM'},
    {date:'2026-09-09', type:'prova', title:'Avaliação Teórica 1 + OSCE 1 (A,B) / Prática em serviços (C,D,E,F)', assessmentId:'av1'},
    {date:'2026-09-16', type:'evento', title:'Semana Integradora'},
    {date:'2026-09-23', type:'evento', title:'SEMUNI'},
    {date:'2026-09-30', type:'seminario', title:'Simulação Grupo D (tontura); Grupo E (dor lombar)'},
    {date:'2026-10-07', type:'evento', title:'Julgamento Simulado CRM-DF'},
    {date:'2026-10-14', type:'seminario', title:'Simulação Grupo F (tosse); Grupo G (dispneia)'},
    {date:'2026-10-21', type:'aula', title:'Mordeduras: profilaxia raiva/tétano; Violência na APS'},
    {date:'2026-10-28', type:'evento', title:'Recesso do Dia do Servidor Público'},
    {date:'2026-11-04', type:'seminario', title:'Simulação Grupo B (cefaleia); Grupo C (disúria)'},
    {date:'2026-11-11', type:'aula', title:'Ansiedade e Reforma Psiquiátrica; Filme "Si può fare"'},
    {date:'2026-11-18', type:'seminario', title:'Simulação Grupo H (depressão/ideação suicida); Grupo I (diarreia)'},
    {date:'2026-11-25', type:'prova', title:'Avaliação Teórica 2 + OSCE 2', assessmentId:'av2'},
    {date:'2026-12-02', type:'seminario', title:'Simulação Grupo J (álcool/dependência); Dor torácica'},
    {date:'2026-12-09', type:'prova', title:'Avaliação Teórica 3 + OSCE 3', assessmentId:'av3'}
  ]
},
...
// ────────────────────────────────────────────────────────
{
  ...
  schedule: [
    {date:'2026-08-11', type:'aula', title:'Apresentação / divisão dos grupos / motivações para ser médico'},
    {date:'2026-08-18', type:'aula', title:'Motivações para escolha da especialidade (discussão de artigos)'},
    {date:'2026-08-25', type:'seminario', title:'Atuação do Médico — Clínica médica'},
    {date:'2026-09-01', type:'seminario', title:'Atuação do Médico — Cirurgia geral'},
    {date:'2026-09-08', type:'seminario', title:'Atuação do Médico — Medicina da família e comunidade'},
    {date:'2026-09-15', type:'evento', title:'Semana da Atividade Integradora (vale 1,5 pts)'},
    {date:'2026-09-22', type:'evento', title:'Semana Universitária — sem aula'},
    {date:'2026-09-29', type:'seminario', title:'Atuação do Médico — Ginecologia-obstetrícia'},
    {date:'2026-10-06', type:'seminario', title:'Atuação do Médico — Psiquiatria'},
    {date:'2026-10-13', type:'seminario', title:'Atuação do Médico — Especialidades clínico-cirúrgicas'},
    {date:'2026-10-20', type:'seminario', title:'Atuação do Médico — Pediatria'},
    {date:'2026-10-27', type:'seminario', title:'Atuação do Médico — Especialidades exclusivamente clínicas'},
    {date:'2026-11-03', type:'seminario', title:'Atuação do Médico — Especialidades exclusivamente cirúrgicas'},
    {date:'2026-11-10', type:'seminario', title:'Atuação do Médico — Medicina de imagem e nuclear'},
    {date:'2026-11-17', type:'seminario', title:'Atuação do Médico — Medicina legal e do trabalho'},
    {date:'2026-11-24', type:'seminario', title:'Atuação do Médico — Medicina preventiva e saúde coletiva'},
    {date:'2026-12-07', type:'evento', title:'Encerramento / Auto-avaliação'}
  ]
},
...
// ────────────────────────────────────────────────────────
{
  ...
  schedule: [
    {date:'2026-08-11', type:'aula', title:'Uso de telas na pediatria'},
    {date:'2026-08-13', type:'aula', title:'Apresentação da disciplina / Doença celíaca; Puericultura do adolescente'},
    {date:'2026-08-14', type:'aula', title:'Médicos Saudáveis, Pacientes Saudáveis'},
    {date:'2026-08-18', type:'aula', title:'Como conduzir a criança com sopro'},
    {date:'2026-08-20', type:'aula', title:'Radiologia na Pediatria; Sexualidade na adolescência'},
    {date:'2026-08-21', type:'aula', title:'Erro Médico'},
    {date:'2026-08-25', type:'aula', title:'Pneumonia'},
    {date:'2026-08-27', type:'aula', title:'Adolescente — "Passando a bola"; Exame neurológico do lactente e criança maior'},
    {date:'2026-08-28', type:'aula', title:'Anestesiologia em Pediatria'},
    {date:'2026-09-01', type:'aula', title:'Crescimento: pré-escolar ao pré-adolescente'},
    {date:'2026-09-03', type:'aula', title:'Discussão de casos — crescimento e puberdade'},
    {date:'2026-09-04', type:'aula', title:'Incongruência de gênero'},
    {date:'2026-09-08', type:'aula', title:'Cuidados paliativos'},
    {date:'2026-09-10', type:'aula', title:'Infecção do trato urinário; Sistema locomotor e artralgia'},
    {date:'2026-09-11', type:'aula', title:'Urologia Pediátrica cirúrgica'},
    {date:'2026-09-15', type:'seminario', title:'Atividade Integradora do Semestre (14 a 17/09)'},
    {date:'2026-09-17', type:'seminario', title:'Atividade Integradora do Semestre (14 a 17/09)'},
    {date:'2026-09-18', type:'aula', title:'Cirurgias otorrinolaringológicas na pediatria'},
    {date:'2026-09-22', type:'evento', title:'Semana Universitária'},
    {date:'2026-09-29', type:'aula', title:'Diagnóstico clínico/laboratorial em genética'},
    {date:'2026-10-01', type:'aula', title:'Diagnóstico clínico/laboratorial de doenças genéticas'},
    {date:'2026-10-02', type:'aula', title:'Controle clínico no pós-operatório'},
    {date:'2026-10-06', type:'aula', title:'Obesidade sindrômica/monogênica'},
    {date:'2026-10-08', type:'prova', title:'PROVA PARCIAL — Módulo Adolescente', assessmentId:'prsa1'},
    {date:'2026-10-08', type:'aula', title:'Infecção de vias aéreas superiores'},
    {date:'2026-10-09', type:'aula', title:'Deformidade da coluna/quadril da criança'},
    {date:'2026-10-13', type:'prova', title:'PROVA PARCIAL — Módulo Criança', assessmentId:'prsc1'},
    {date:'2026-10-15', type:'aula', title:'Atividade física para crianças e adolescentes; Sepse'},
    {date:'2026-10-16', type:'aula', title:'TCE e hemorragia subaracnoidea'},
    {date:'2026-10-20', type:'aula', title:'Calendário vacinal'},
    {date:'2026-10-22', type:'seminario', title:'Seminário da disciplina'},
    {date:'2026-10-23', type:'aula', title:'Oncologia Pediátrica'},
    {date:'2026-10-27', type:'aula', title:'Dermatite atópica'},
    {date:'2026-10-29', type:'aula', title:'Asma (módulo criança e adolescente)'},
    {date:'2026-10-30', type:'aula', title:'Gestação na adolescência'},
    {date:'2026-11-03', type:'aula', title:'Transtorno do espectro autista'},
    {date:'2026-11-05', type:'aula', title:'Condições neurológicas crônicas; Depressão na Adolescência'},
    {date:'2026-11-06', type:'aula', title:'Desvio/dismetrias dos MMII; pé da criança e adolescente'},
    {date:'2026-11-10', type:'aula', title:'Homeopatia'},
    {date:'2026-11-12', type:'aula', title:'Atividade de Extensão; Violência contra criança e adolescente'},
    {date:'2026-11-13', type:'aula', title:'Apendicite em pacientes pediátricos'},
    {date:'2026-11-17', type:'aula', title:'Desidratação'},
    {date:'2026-11-19', type:'prova', title:'PROVA FINAL — Módulo Adolescente', assessmentId:'prsa2'},
    {date:'2026-11-20', type:'evento', title:'Feriado — Consciência Negra'},
    {date:'2026-11-24', type:'prova', title:'PROVA FINAL — Módulo Criança', assessmentId:'prsc2'},
    {date:'2026-11-26', type:'reposicao', title:'Reposição (com justificativa)'},
    {date:'2026-11-27', type:'prova', title:'PROVA — Módulo Cirurgia Pediátrica', assessmentId:'cirurgia'},
...
// ────────────────────────────────────────────────────────
{
  ...
  schedule: [
    {date:'2026-08-10', type:'aula', title:'Avaliação/preparo pré-anestésico; Exame oftalmológico e ametropias'},
    {date:'2026-08-17', type:'aula', title:'Conceitos básicos em ortopedia; Otites e complicações'},
    {date:'2026-08-24', type:'aula', title:'Traumatologia: classificação; Diagnóstico diferencial de olho vermelho'},
    {date:'2026-08-31', type:'aula', title:'Lesões traumáticas fundamentais; Rinossinusites e complicações'},
    {date:'2026-09-14', type:'aula', title:'Via aérea e ventilação'},
    {date:'2026-09-14', type:'seminario', title:'Seminário Integrador'},
    {date:'2026-09-21', type:'evento', title:'Semana Universitária'},
    {date:'2026-09-28', type:'aula', title:'Anestesia regional; Catarata'},
    {date:'2026-10-05', type:'aula', title:'Infecções osteoarticulares; Doenças do anel de Waldeyer'},
    {date:'2026-10-19', type:'aula', title:'Dor: neurofisiologia; Glaucoma'},
    {date:'2026-10-26', type:'aula', title:'Lombalgias mecânicas; Produção da voz e disfonias'},
    {date:'2026-11-09', type:'aula', title:'Anestesia geral inalatória; Estrabismo'},
    {date:'2026-11-16', type:'aula', title:'Osteoartrose (joelho/quadril); Tumores de boca e laringe'},
    {date:'2026-11-23', type:'aula', title:'Anestesia geral venosa; Retinopatia diabética/hipertensiva'},
    {date:'2026-11-30', type:'prova', title:'Prova — Ortopedia/Oftalmologia', assessmentId:'prova_ortoped_oftalmo'},
    {date:'2026-11-30', type:'aula', title:'Afecções das glândulas salivares'},
    {date:'2026-12-07', type:'prova', title:'Prova de Anestesia', assessmentId:'prova_anestesia'},
    {date:'2026-12-07', type:'prova', title:'Prova de Otorrinolaringologia', assessmentId:'prova_orl'}
  ]
}
